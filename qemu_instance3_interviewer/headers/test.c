...
{
        wp(label) , wp(qlabel), wp(clabel), wp(" . ") , wp(ques) ,wp(br);
}
...
{
        wp("<textarea rows=\"4\" cols=\"50\" id=\"danswer\" placeholder=\"Enter your answer here\" maxlength=\""),wp(PQgetvalue(res1,0,1)), wp ("\">");
