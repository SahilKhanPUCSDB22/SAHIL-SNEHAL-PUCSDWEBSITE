...
res1=PQexecParams(con,(char*)getmcq,2,NULL,(const char* const*)params,NULL,NULL,0);
...
res1=PQexecParams(con,(char*)opsrand,2,NULL,(const char* const*)params,NULL,NULL,0);
